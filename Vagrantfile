...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = "dev.laravel4admin.com"
  ...
  config.vm.synced_folder "project", "/var/www/public", :owner => "www-data", :group => "www-data", :mount_options => ["dmode=777","fmode=664"]
